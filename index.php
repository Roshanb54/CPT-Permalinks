<?php get_header(); ?>
			<div role="main">
				...
				<p>Say hello to a <strong>free WordPress theme</strong> containing two examples of custom post types; one hierarchical (Products) and one with custom taxonomies (Recipes).</p>
				<p>The theme is focused on two common problems: achieving a template &amp; menu architecture that works solidly, with permalinks that contain a taxonomy term in the URL e.g. <code>/post-type/taxonomy-term/post-name</code></p>
				...
				<p><strong><a href="https://github.com/mattberridge/CPT-Permalinks">Download on Github</a></strong></p>
