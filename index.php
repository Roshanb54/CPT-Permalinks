<?php get_header(); ?>
			<div role="main">
				...
				<p>Say hello to a WordPress theme containing two more complicated <strong>examples of custom post types</strong>; one hierarchical (Products) and one with custom taxonomies (Recipes). The theme is focused on two common problems: creating "pretty" permalinks which include a taxonomy, and a menu architecture that works solidly.</p>
